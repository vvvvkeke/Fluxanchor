...
def _get_transfer_ec_number_entry(ec_number_entry_key: str, brenda_kcat_database_original: Dict[str, Dict[str, Any]]) -> \
Dict[str, Any]:
...
def create_combined_kcat_database(sabio_rk_kcat_database_path: str, brenda_kcat_database_path: str,
...
def _get_kcat_list(searched_metabolites: List[str], complete_entry: Dict[str, Any], complete_entry_sa: Dict[str, Any],
                   MW, organism: str,
    ...
    * protein_kcat_database ~ The protein<->kcat database
    ...
    if protein_kcat_database != {}:
        protein_database_kcat = _get_kcat_from_protein_kcat_database(searched_direction, reaction,
...
def _get_kcat(searched_metabolites, complete_entry, complete_entry_sa, MW, organism: str, searched_direction: str,
    ...
    * type_of_kcat_selection: str ~ The type of kcat selection. Can be "mean", "median" or "random". Is "mean" by default.
    ...
    [kcat_list, ori_kcat, species_list, kcat_extend] = _get_kcat_list(searched_metabolites, complete_entry,
                                                                      complete_entry_sa, MW, organism,
                                                                      searched_direction, reaction,
                                                                      protein_kcat_database)  # Mr.Mao
...
# PUBLIC FUNCTIONS
def get_reactions_kcat_mapping(sbml_path: str, project_folder: str, project_name: str, organism: str,
    ...
    *type_of_kcat_selection: str ~ Can be "mean", "median" or "random". Refers to the selection of found kcats of a reaction.
    ...
    for reaction in model.reactions:
        ...
        [forward_kcat, forward_kcat_list, ori_forward_kcat, forward_species_list, kcat_extend] = _get_kcat(
            searched_educts, complete_entry, complete_entry_sa, MW, organism, "forward", reaction,
            protein_kcat_database, type_of_kcat_selection)  # Mr.Mao
        ...
        [reverse_kcat, reverse_kcat_list, ori_reverse_kcat, reverse_species_list, kcat_extend] = _get_kcat(
            searched_products, complete_entry, complete_entry_sa, MW, organism, "reverse", reaction,
            protein_kcat_database, type_of_kcat_selection)  # Mr.Mao
